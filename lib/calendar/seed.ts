...
export function loadEmptyCalendar(): CalendarData {
  ...
  return {...base,blocks:[],categories:[],groups:[],quoteBank:[],currentQuote:'',deletedCalendars:[],settings:{...base.settings,defaultCategoryId:'',todoTabs:[{id:'todo-inbox',name:'TO DO'}],todoItems:[]}}
}
