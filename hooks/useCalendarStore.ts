...
export function useCalendarStore() {
  ...
  return useMemo(()=>({data,ready,undo,setUndo,canUndo:past.length>0,canRedo:future.length>0,undoHistory,redoHistory,undoDelete,addBlock,addBlocks,createBlock,updateBlock,updateBlocks,deleteBlocks,patchSettings,toggleCategory,toggleGroup,reorderCategories,moveCategoryToGroup,applyCategoryLayout,reorderGroups,renameGroup,createGroup,renameCategory,createCategory,colorCategory,setDefaultCategory,deleteCategory,restoreCategory,mergeCategory,setQuote,nextQuote,copyPlanToActual,reset,replaceData}),[data,ready,undo,past.length,future.length,undoHistory,redoHistory,undoDelete,addBlock,addBlocks,createBlock,updateBlock,updateBlocks,deleteBlocks,patchSettings,toggleCategory,toggleGroup,reorderCategories,moveCategoryToGroup,applyCategoryLayout,reorderGroups,renameGroup,createGroup,renameCategory,createCategory,colorCategory,setDefaultCategory,deleteCategory,restoreCategory,mergeCategory,setQuote,nextQuote,copyPlanToActual,reset,replaceData])
}
